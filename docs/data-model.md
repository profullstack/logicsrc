...
- [OpenFleet](/docs/openfleet) groups OpenAgent profile references and/or OpenSwarm file-key references, with fleet metadata and CoinPay rental offers scoped to the fleet or named members.
